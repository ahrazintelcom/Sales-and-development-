                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-middle">
                        ...
                        <?php foreach ($leads as $lead): ?>
                            <?php
                            $isAiLead = ($lead['source'] ?? '') === 'google_places';
                            $leadUrl = !empty($lead['id']) ? BASE_URL . '/?route=leads/view&id=' . $lead['id'] : '';
                            ?>
                            <tr <?= $leadUrl ? 'class="lead-row" data-lead-row data-lead-url="' . htmlspecialchars($leadUrl, ENT_QUOTES) . '"' : '' ?>>
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <?php if (!empty($lead['id'])): ?>
                                        <a href="<?= BASE_URL ?>/?route=leads/view&id=<?= $lead['id'] ?>" class="btn btn-sm btn-primary ms-1"><i class="bi bi-eye"></i> View Lead</a>
